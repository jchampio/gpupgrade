...
func TestCreateSegmentDataDirectories(t *testing.T) {
	...
	c := MustCreateCluster(t, []utils.SegConfig{
		...
		{ContentID: -1, DbID: 4, Port: 15433, Hostname: "host3", DataDir: "/data/qddir/seg-1", Role: "m", PreferredRole: "m"},
		{ContentID: 0, DbID: 5, Port: 35432, Hostname: "host3", DataDir: "/data/dbfast1/seg1", Role: "m", PreferredRole: "m"},
		{ContentID: 1, DbID: 6, Port: 35433, Hostname: "host3", DataDir: "/data/dbfast2/seg2", Role: "m", PreferredRole: "m"},
	})
