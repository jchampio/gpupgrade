...
func TestAgentHosts(t *testing.T) {
	cases := []struct {
		...
		hub.MustCreateCluster(t, []utils.SegConfig{
			{ContentID: -1, Hostname: "mdw", Role: "p", PreferredRole: "p"},
			{ContentID: 0, Hostname: "sdw1", Role: "p", PreferredRole: "p"},
			{ContentID: 1, Hostname: "sdw1", Role: "p", PreferredRole: "p"},
		}),
		[]string{"sdw1"},
	}, {
		...
		hub.MustCreateCluster(t, []utils.SegConfig{
			{ContentID: -1, Hostname: "mdw", Role: "p", PreferredRole: "p"},
			{ContentID: 0, Hostname: "mdw", Role: "p", PreferredRole: "p"},
		}),
		[]string{"mdw"},
	}, {
		...
		hub.MustCreateCluster(t, []utils.SegConfig{
			{ContentID: -1, Hostname: "mdw", Role: "p", PreferredRole: "p"},
			{ContentID: -1, Hostname: "smdw", Role: "m", PreferredRole: "m"},
			{ContentID: 0, Hostname: "sdw1", Role: "p", PreferredRole: "p"},
			{ContentID: 0, Hostname: "sdw1", Role: "m", PreferredRole: "m"},
			{ContentID: 1, Hostname: "sdw1", Role: "p", PreferredRole: "p"},
			{ContentID: 1, Hostname: "sdw2", Role: "m", PreferredRole: "m"},
		}),
