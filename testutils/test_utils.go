...
func CreateMultinodeSampleCluster(baseDir string) *utils.Cluster {
	return &utils.Cluster{
		...
		Primaries: map[int]utils.SegConfig{
			-1: {ContentID: -1, DbID: 1, Port: 15432, Hostname: "localhost", DataDir: baseDir + "/seg-1", Role: "p", PreferredRole: "p"},
			0:  {ContentID: 0, DbID: 2, Port: 25432, Hostname: "host1", DataDir: baseDir + "/seg1", Role: "p", PreferredRole: "p"},
			1:  {ContentID: 1, DbID: 3, Port: 25433, Hostname: "host2", DataDir: baseDir + "/seg2", Role: "p", PreferredRole: "p"},
		},
	}
}
